...
export class FloatField extends ValidatorField {
    ...
    _setErrorMessageInvalidType(message) {
        this._errorMessageInvalidType = message !== undefined ? message : `invalid value, expected a ${DATA_TYPE_TO_COMMON_NAME[DATA_TYPE.float]}`;
    }
    ...
    max(rangeMax, message = undefined) {
        this._valueIdentifier[1] = rangeMax;
