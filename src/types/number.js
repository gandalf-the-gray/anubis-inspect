...
export class NumberField extends BaseField {
    ...
    constructor(valueIdentifier, isRequired = NumberField.defaultIsRequired) {
        super({valueIdentifier, type: DATA_TYPE.number, range: [NumberField.defaultMin, NumberField.defaultMax], isRequired});
    ...
    setErrorMessageInvalidType(message) {
        this.errorMessageInvalidType = message !== undefined ? message : `Invalid value, expected a ${DATA_TYPE_TO_COMMON_NAME[DATA_TYPE.number]}`;
    }
